...
if __name__ == '__main__':
    ...
    batch_size = 64
    lr = 0.01
    config = {"save_path": "./model_vgg", "early_stop": 20, 'n_epochs': 200}
    ...
    trainloader = DataLoader(train_data, batch_size=batch_size, shuffle=False, num_workers=3, pin_memory=True)

    test_data = torchvision.datasets.CIFAR10(root='./data', train=False, download=True, transform=transform_test)
    testloader = DataLoader(test_data, batch_size=batch_size, shuffle=False, num_workers=3, pin_memory=True)
